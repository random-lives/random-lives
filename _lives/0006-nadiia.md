...
# Age at death: 4
# Birth date: July 13, 1920 AD
# Birth year: 1920 AD
# Birthplace altitude: 190
# Birthplace annual precipitation: 595.0
# Birthplace biome: Temperate Broadleaf & Mixed Forests
# Birthplace coldest month temp: -8.63800048828125
# Birthplace cropland percentage: 61.54
...
# Birthplace latitude: 49.64
# Birthplace longitude: 29.79
# Birthplace map url: https://www.google.com/maps/place/49.64,29.79/@49.64,29.79,5z
# Birthplace mean temp: 8.0111665725708
# Birthplace modern address: Антонів, Сквирська міська громада, Білоцерківський район,
#   Київська область, 09052, Україна
# Birthplace modern country: Ukraine
# Birthplace modern region: Kyïvs'ka Oblast'
# Birthplace pasture percentage: 7.99
# Birthplace population density: 34.380001068115234
# Birthplace rainfed_not_rice percentage: 61.54
# Birthplace rainfed_rice percentage: 0.0
# Birthplace rangeland percentage: 0.0
# Birthplace urban_area percentage: 0.0
# Birthplace warmest month temp: 24.99799919128418
# Death date: March 16, 1925 AD
# Era: Holocene
# Lifestyle: Rural
# Name: Nadiia
...
# cause_of_death: Measles complications
# ethnicity: Ukrainian (East Slavic, Right-Bank rural peasant community)
# father_occupation: Peasant farmer on family land (crop farming with some livestock;
#   household-based agriculture)
# household_social_status: Middle peasant (seredniak; typical self-sufficient smallholder)
# household_structure_at_birth: Two-parent extended household (parents + children +
#   one/both grandparents)
# language: Ukrainian (local Right-Bank/Central Ukrainian dialect)
# mother_occupation: Peasant housewife-farm worker (childcare + cooking + household
#   work + seasonal field labor; tending poultry/small stock)
# narrative_plan:
#   caretakers:
#   - death_year: null
#     name: Hryhorii
...
#   at home, limited church attendance due to pressure or disruption)
