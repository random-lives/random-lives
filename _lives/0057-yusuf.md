...
# Age at death: 3
# Birth date: September 16, 1880 AD
# Birth year: 1880 AD
# Birthplace altitude: 1816
# Birthplace annual precipitation: 1024.0
# Birthplace biome: Montane Grasslands & Shrublands
# Birthplace coldest month temp: 9.913999557495117
# Birthplace cropland percentage: 9.49
# Birthplace ecotype: Ethiopian montane grasslands and woodlands
# Birthplace irrigated_not_rice percentage: 0.0
# Birthplace irrigated_rice percentage: 0.0
# Birthplace latitude: 8.82
# Birthplace longitude: 40.54
# Birthplace map url: https://www.google.com/maps/place/8.82,40.54/@8.82,40.54,5z
# Birthplace mean temp: 19.307540893554688
# Birthplace modern address: Gelemso, West Harerghe, ኦሮሚያ ክልል Oromia أوروميا, ኢትዮጵያ
# Birthplace modern country: Ethiopia
# Birthplace modern region: Hararge
# Birthplace pasture percentage: 12.5
# Birthplace population density: 16.649999618530273
# Birthplace rainfed_not_rice percentage: 9.49
# Birthplace rainfed_rice percentage: 0.0
# Birthplace rangeland percentage: 0.0
# Birthplace urban_area percentage: 0.0
# Birthplace warmest month temp: 27.385000228881836
# Death date: November 1, 1883 AD
# Era: Holocene
# Lifestyle: Rural
# Name: Yusuf
...
# cause_of_death: Measles and its complications (often with pneumonia/diarrhea)
# ethnicity: Other local minorities (e.g., Gurage traders, mixed households, others)
# father_occupation: Smallholder/tenant cultivator (rainfed cereals/enset/other local
#   crops; may rent/sharecrop land)
# household_social_status: Poor free household (smallholding/land-poor, laboring, food
#   insecurity common)
# household_structure_at_birth: Stepfamily household (one biological parent + stepparent
#   due to widowhood/divorce/remarriage, with half-siblings/step-siblings present)
# language: Oromo + home minority language (e.g., Gurage/Semitic or other) bilingual
# mother_occupation: Domestic/childcare + tending small livestock/dairying (goats/sheep/chickens;
#   milk/butter handling)
# narrative_plan:
#   caretakers:
#   - death_year: null
#     name: Abdullahi
...
#   ceremonies, offerings/vows at sacred trees/springs) alongside Muslim prayer/amulets'
